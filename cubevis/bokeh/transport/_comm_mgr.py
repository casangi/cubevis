    ...
    async def _handle_request(self, msg: Dict[str, Any]):
        ...
        try:
            ...
            if len(sig.parameters) >= 2:
                ...
                result = handler(msg['message'], self._context)
            else:
