...
from cubevis.private.apps import InteractiveCleanJPY

def _icleanjpy_t( *args, **kwargs ):
    ic = InteractiveCleanJPY( *args, **kwargs )
    return ic( )
